  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-5 sm:px-6 lg:px-8 py-16 prose prose-invert prose-headings:font-display prose-a:text-ember-400 text-white/85 space-y-8">
        <section>
          <h2 className="text-xl font-bold text-white neon-title">1. Responsable du traitement</h2>
          <p>[Raison sociale], [Adresse], [email à compléter] — est responsable du traitement de vos données personnelles.</p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-white neon-title">2. Données collectées</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-white neon-title">3. Base légale</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-white neon-title">4. Durée de conservation</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-white neon-title">5. Destinataires des données</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-white neon-title">6. Cookies et analytics</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-white neon-title">7. Vos droits (RGPD)</h2>
